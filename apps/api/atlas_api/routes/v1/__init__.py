...
from .admin_sports_providers import router as admin_sports_providers_router
...
from .media_retention import router as media_retention_router
...
router.include_router(media_retention_router)
