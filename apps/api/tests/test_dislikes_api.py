"""Security and contract tests for the authenticated Dislikes API."""
...
from atlas.dislike_service import DislikeMutationResult
from atlas_api.auth.models import AuthenticatedUser
from atlas_api.main import create_app
from atlas_api.routes.v1.dislikes import (
...
def dislike_record(
    *,
    ...
    """Return one valid serialized Dislike record."""
...
class DislikesEndpointTests(unittest.TestCase):
    """Verify the authenticated, self-scoped Dislikes routes."""

    def setUp(self) -> None:
        self.app = create_app()
        self.service = StubDislikesAPIService()
    ...
    def test_list_uses_authenticated_user_scope(
        ...
        self.assertEqual(
            USER_ID,
            response.json()["dislikes"][0]["user_id"],
        )
    ...
    def test_openapi_registers_dislikes_routes(
        self,
    ) -> None:
...
class DislikesServiceSecurityTests(
    unittest.TestCase
):
